...
// template classes usually contained in header files
...
int main() {
	...
	Item<int> item1{ "Dmitrii", 100 };
	std::cout << item1.get_name() << " " << item1.get_value() << std::endl;

	Item <std::string> item2{ "Dmitrii", "String value" };
	std::cout << item2.get_name() << " " << item2.get_value() << std::endl;

	Item<Item<std::string>> item3{ "Dmitrii", {"C++", "Expert"} };
