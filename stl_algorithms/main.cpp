...
// find an element in container
void find_test(){
    std::cout << "\n=========================" << std::endl;
    std::vector<int> vec{1,2,3,4,5};
    auto loc = std::find(std::begin(vec), std::end(vec), 1);  // can be used with any type of containers
...
// transforms elements in a container
// in this case string considered as container
void string_transfrom_test(){
    std::cout << "\n=============================" << std::endl;
